                            ...
                            <td>
                                <div class="product-item">
                                    <div class="product-thumb">
                                        <img src="{{ $product->imageShow() }}" alt="products">
                                    </div>
                                    <div class="product-content">
                                        <h6 class="name">
                                            <a href="{{ route('product.detail', [slug($product->name), $product->id]) }}" class="productName" data-product_id="{{ $product->id }}">{{ __($product->name) }}</a>
                                        </h6>
                                    </div>
                                </div>
                            </td>
