...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <form action="{{ route('user.deposit.insert', $order->id ?? 0) }}" method="post">
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" name="amount" class="form-control form--control" value="{{ getAmount(@$order->total) }}" autocomplete="off" {{ $order ? 'readonly' : '' }}>
                        ...
                        <button type="submit" class="btn btn--base cmn--btn w-100 mt-3">@lang('Submit')</button>
                    </div>
                </div>
            </form>
        </div>
