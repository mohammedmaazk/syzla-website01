                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="cur_text" required value="{{ __($general->cur_text) }}">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group ">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label>@lang('Today Deal discount') </label>
                                <div class="input-group">
                                    <input type="number" class="form-control" name="discount" value="{{ getAmount($general->discount) }}" required>
                                    <select name="discount_type" class="input-group-text  border-0">
                                        <option value="1" @selected($general->discount_type == 1)>{{ __($general->cur_text) }}</option>
                                        <option value="2" @selected($general->discount_type == 2)>@lang('%')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
