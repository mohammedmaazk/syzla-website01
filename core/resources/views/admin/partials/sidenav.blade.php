                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.product*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.product.feature.index') }}">
                                <a href="{{ route('admin.product.feature.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Featured Product') </span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.hot') }}">
                                <a href="{{ route('admin.product.hot') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Hot Deal Products') </span>
                                </a>
                            </li>
